...
export default function CompanyBlog() {
  ...
  return (
    <div className="bg-black text-white mt-10 overflow-x-hidden">
          ...
          {blogPosts.map((post) => (
            <div key={post.id} className="group cursor-pointer">
              ...
              <div className="space-y-3">
                ...
                {/* Read More */}
                <div className="flex items-center text-yellow-500 font-semibold text-sm gap-1 group-hover:gap-2 transition-all">
                  Read More
                  <svg
      ...
      {/* Floating Badge */}
      <div className="fixed bottom-6 right-6 md:bottom-8 md:right-8 bg-gray-900 text-white rounded-full w-16 h-16 flex items-center justify-center shadow-lg hover:bg-yellow-500 transition-colors cursor-pointer">
